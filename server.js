...
const WIDGET_URI = "ui://widget/bettergeometry-v0.1.0.1.html";
...
function widgetResource() {
  return {
    ...
    description: "The BetterGeometry generic SVG scene renderer widget.",
...
function widgetContents() {
  return {
    ...
    text: widgetHtml,
    _meta: {
      "openai/widgetDescription": "BetterGeometry renders generic geometry scene JSON as SVG.",
...
function callShowBetterGeometry(params = {}) {
  ...
  const message = typeof rawMessage === "string" && rawMessage.trim()
    ? rawMessage.trim()
    : "Generic scene renderer is connected.";
